    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <form action="insertar.php" method="POST">
                ...
                <input type="text" required class="form-control mb-3" name="apellido" placeholder="Inserte su apellido">
                <input type="text" required class="form-control mb-3" name="telefono" placeholder="Inserte su telefono">
